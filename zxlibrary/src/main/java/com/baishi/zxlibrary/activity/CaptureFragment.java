...
import com.baishi.zxlibrary.decoding.CaptureActivityHandler;
import com.baishi.zxlibrary.decoding.InactivityTimer;
import com.baishi.zxlibrary.view.ViewfinderView;
...
public class CaptureFragment extends Fragment implements SurfaceHolder.Callback {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        int screenWidth = (int) ((float)getScreenWidth(getActivity())*0.7f);
        viewfinderView.setWidthHeight(screenWidth,screenWidth);
        return view;
    }
    ...
    public void handleDecode(Result result, Bitmap barcode) {
        ...
        if (result == null || TextUtils.isEmpty(result.getText())) {
            ...
            if (analyzeCallback != null) {
                Log.e("扫描结果",""+result.getBarcodeFormat().name());
                analyzeCallback.onAnalyzeSuccess(barcode, result.getBarcodeFormat().name(),result.getText());
            }
        }
    }
