package com.xinyartech.baselibrary.view.popup;
...
public class QMUIPopup extends QMUIBasePopup {
    ...
    public static final int ANIM_NONE = 5;
...
//        }
        ...
        switch (mAnimStyle) {
            ...
            case ANIM_GROW_FROM_LEFT:
                mWindow.setAnimationStyle(onTop ? R.style.PopUpMenuLeft : R.style.PopDownMenuLeft);
                break;

            case ANIM_GROW_FROM_RIGHT:
                mWindow.setAnimationStyle(onTop ? R.style.PopUpMenuRight : R.style.PopDownMenuRight);
                break;

            case ANIM_GROW_FROM_CENTER:
                mWindow.setAnimationStyle(onTop ? R.style.PopUpMenuCenter : R.style.PopDownMenuCenter);
                break;
            case ANIM_AUTO:
