...
import com.xinyartech.baselibrary.view.popup.quiutil.QMUIDisplayHelper;
...
public abstract class QMUIBasePopup {
    ...
    protected void onShowConfig() {
        if (mRootViewWrapper == null) {
            throw new IllegalStateException("setContentView was not called with a view toGeRen display.");
        }
